...
var { fromImpliedDecimal} = require("./numberUtils");
var Types = {};
...
Types.asset = {
    fromByteBuffer(b){
        ...
        let symbol = new Buffer(b_copy.toBinary(), "binary").toString().replace(/\x00/g, "").replace("STEEM", "TESTS").replace("SBD", "TBD")
        b.skip(7);
    ...
    toObject(object, debug = {}){
        if (debug.use_default && object === undefined) { return "0.000 TESTS"; }
        return object
    }
}
